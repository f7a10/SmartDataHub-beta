...
class ChartManager {
    ...
    renderChartOptions() {
        ...
        // Simple layout with all chart options in a single grid
        this.chartOptions.forEach(option => {
            ...
            chartOption.className = `chart-option ${suitableClass}`;
            chartOption.dataset.chartType = option.id;
            ...
            chartOption.addEventListener('click', () => this.toggleChartSelection(option.id));
